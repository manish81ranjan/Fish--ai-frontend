...
def create_app():
    ...
    def marketplace():
        return send_from_directory(FRONTEND_PAGES, "marketplace.html")

    @app.route("/ai-fish")
    def ai_fish():
        return send_from_directory(FRONTEND_PAGES, "ai-fish.html")

    @app.route("/cart")
    def cart():
        return send_from_directory(FRONTEND_PAGES, "cart.html")

    @app.route("/orders")
    def orders():
        return send_from_directory(FRONTEND_PAGES, "orders.html")

    @app.route("/auth")
    def auth():
        return send_from_directory(FRONTEND_PAGES, "auth.html")
    ...
    @app.route("/checkout")
    def checkout():
        return send_from_directory(FRONTEND_PAGES, "checkout.html")

    @app.route("/product/<pid>")
    def product_page(pid):
        return send_from_directory(FRONTEND_PAGES, "product.html")
