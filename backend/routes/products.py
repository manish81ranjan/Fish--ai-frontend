...
IMAGE_DIR = os.path.join(STATIC_DIR, "reviews")
VIDEO_DIR = os.path.join(STATIC_DIR, "review_videos")
...
def add_review():
    ...
    for img in images:
        if img and img.filename:
            ...
            img.save(os.path.join(IMAGE_DIR, secure_filename(filename)))
    ...
    if video and video.filename:
        ...
        video_name = f"{uuid.uuid4()}.{vext}"
        video.save(os.path.join(VIDEO_DIR, secure_filename(video_name)))
